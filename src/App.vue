            ...
            <ul class="colors colors--black">
              <li class="colors__item">
                <label class="colors__label" for="input1">
                  <input aria-labelledby="#input1" id="input1" class="colors__radio sr-only"
              ...
              <li class="colors__item">
                <label class="colors__label" for="input2">
                  <input aria-labelledby="#input2" id="input2" class="colors__radio sr-only"
              ...
              <li class="colors__item">
                <label class="colors__label" for="input3">
                  <input aria-labelledby="#input3" id="input3" class="colors__radio sr-only"
                  type="radio" name="color-1" value="#222">
